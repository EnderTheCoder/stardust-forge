...
public class TileEntityTypeRegistry {
    ...
    public static RegistryObject<TileEntityType<AbstractTurretMediumTileEntity>> RAIL_GUN_4_MEDIUM_TILE_ENTITY = TILE_ENTITY_TYPE_DEFERRED_REGISTER.register("rail_gun_4_medium_tile_entity", () -> TileEntityType.Builder.create(AbstractTurretMediumTileEntity::new, BlockRegistry.RAIL_GUN_4_MEDIUM.get()).build(null));
